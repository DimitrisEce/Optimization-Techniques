function [vectors,fvalues,gradientvalues,iterations]=NewtonsMethod(f,fgradient,fhessian,x0,maxiterations,e,gammamethod)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        [~,p]=chol(hessian);
        if p~=0
            fprintf("The Hessian is not positive definite. Error in algorithm requirments.\n\n");
            break;
        end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
        if norm(gradient)<e
